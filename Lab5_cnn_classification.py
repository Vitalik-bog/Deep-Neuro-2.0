...
if __name__ == '__main__':
    ...
    # Устанавливаем разрешение на использование дополнительных библиотекx
    ...
    train_dataset = torchvision.datasets.ImageFolder(root='D:/Учеба(Лабораторные )/DeepNeuro/Laba 5/data/train', transform=data_transforms)
    test_dataset = torchvision.datasets.ImageFolder(root='D:/Учеба(Лабораторные )/DeepNeuro/Laba 5/data/test', transform=data_transforms)
